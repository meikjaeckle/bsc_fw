...
void ChargeVoltageCtrl::calcChargeVoltage(Inverter &inverter, inverters::InverterData &inverterData)
{
...
/* */
uint16_t ChargeVoltageCtrl::calcDynamicReduzeChargeVolltage(inverters::InverterData &inverterData, uint16_t u16_lChargeVoltage)
{
